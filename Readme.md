...
Michalski, N., Soliman, L., Reis, M., Tetzlaff, F., Nowossadeck, E., & Hoebel, J. (2026). German Index of Socioeconomic Deprivation (GISD) [Data set]. Zenodo. [https://doi.org/10.5281/zenodo.18983808](https://doi.org/10.5281/zenodo.18983808)
<!-- CITATION_END -->
...
**Zusammenfassung**    
Der German Index of Socioeconomic Deprivation (GISD) ist ein am Robert Koch-Institut entwickelter Index zur Erfassung regionaler sozioökonomischer Benachteiligung. Er wird verwendet, um regionale sozioökonomische Ungleichheiten in der Gesundheit sichtbar zu machen und Ansatzpunkte zur Erklärung regionaler Unterschiede in der Gesundheit aufzeigen zu können. Zur Generierung des GISD werden Indikatoren zur Verteilung von Bildung, Beschäftigung und Einkommen auf Kreis- und Gemeindeebene aus der INKAR-Datenbank verwendet. Die verwendeten Daten stammen aus öffentlich zugänglichen Quellen, vor allem aus der INKAR-Datenbank des Bundesinstituts für Bau-, Stadt- und Raumforschung (BBSR). Die Gewichtung der Indikatoren wird über Hauptkomponentenanalysen und einem Faktor-Scoring innerhalb der Teildimensionen vorgenommen. Die GISD-Daten werden auf verschiedenen regionalen Ebenen, von Gemeinden bis zu NUTS-2-Regionen bezogen auf den Gebietsstand 31.12.2023, aggregiert und für den Zeitraum von 1998 bis 2023 bereitgestellt. Als ein bedeutendes Instrument in der epidemiologischen Forschung und Gesundheitsberichterstattung ermöglicht der GISD eine fundierte Analyse der sozialen Ungleichheit und ihrer Auswirkungen auf die Gesundheit in Deutschland.
...
Die Federführung der Entwicklung, Betreuung und Primäranwendung liegt im [Fachgebiet 28 | Sozialen Determinanten der Gesundheit](https://www.rki.de/DE/Institut/Organisation/Abteilungen/Abteilung-2/FG28/fg28_org.html). Autor:innen des aktuellen Datensatzes sind [Niels Michalski](https://orcid.org/0000-0002-5943-1361) und [Lola Omar Soliman](https://orcid.org/0009-0001-6956-0132). Die Projektleitung liegt bei [Jens Hoebel](https://orcid.org/0000-0002-6623-1579). Die [Ursprungsversion des GISD](https://doi.org/10.7802/1460)  wurde von [Lars E. Kroll](https://www.zi.de/das-zi/das-institut-auf-einen-blick/mitarbeitende/detailansicht/lars-e-kroll) erstellt. Aktualisierungen und Revisionen des GISD erscheinen in regelmäßigen Abständen. Fragen zur Generierung und Verwendung des GISD können an [GISD@rki.de](mailto:GISD@rki.de) gerichtet werden.   
...
Gemäß dieser Kriterien wird der GISD auf Ebene der Gemeinden jahresweise für den Zeitraum 1998 bis 2023 generiert und für die unterschiedliche Raumabgrenzungen (Gemeindeverbände, Kreis, Raumordnungsregionen, NUTS-2) bevölkerungsgewichtet aggregiert. Auf jeder räumlichen Ebene wird jeder Region des Gebietsstands ein Wert zugeordnet. 



|Ebene                                              | Anzahl (Stand 31.12.2023)|
|:--------------------------------------------------|-------------------------:|
|Gemeinden                                          |                     10775|
|Gemeindeverbände und verbandsfreie Gemeinden (GVB) |                      4391|
...
|Einkommen     |Einkommensteuer                             |Einkommensteuer in € je Einwohner:in                                                                      |Gemeinde        |Volkswirtschaftliche Gesamtrechnung der Länder                        |
...
*Quellen: [INKAR 2025](https://www.inkar.de/), [Statistik der Bundesagentur für Arbeit](https://statistik.arbeitsagentur.de/)*
...
In den Dateien mit Referenz Bundesland ([GISD_Bundesland.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bundesland.tsv) oder `{XX}_GISD_{Bundesland}.xlsx`) sind die GISD-Daten bezogen auf die jeweiligen Bundesländer abgelegt mit Ausnahme der Stadtstaaten Bremen, Hamburg und Berlin. Innerhalb der Stadtstaaten kann bisher nicht regional differenziert werden. In diesen Dateien sind die GISD-Werte auf die regionalen Einheiten aus den jeweiligen Bundesländern beschränkt. Die GISD-Scores sind min-max-normalisiert, so dass die regionalen Einheit mit der niedrigsten sozioökonomischen Deprivation im jeweiligen Bundesland einen GISD-Score von 0 aufweist und die regionalen Einheit mit der höchsten sozioökonomischen Deprivation einen GISD-Wert von 1. Auch die Variablen zu den GISD-Quintilen, GISD-Dezilen und GISD-Kategorien sind hier auf die Auswahl der regionalen Einheit im Bundesland bezogen. Innerhalb der bundeslandspezifischen Dateien wird wird in separaten Mappen (`{XX}_GISD_{Bundesland}.xlsx`) oder über die Filtervariable `region_type` ([GISD_Bundesland.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bundesland.tsv)) zwischen den regionalen Ebenen (Gemeinde, Kreis) unterschieden. 

Das aktuelle Release entspricht der Version [GISD Release 2026 v0.1](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/tree/main/GISD_Release_aktuell). Frühere Versionen finden sich im [Archiv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/tree/main/Archiv/).

>[!Important]
> Die Datei [GISD_Bundesland.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bundesland.tsv) enthält GISD-Scores, die in Bezug auf das jeweilige Bundesland min-max-normalisiert sind. Für den Vergleich innerhalb eines Bundesland muss in der Datei [GISD_Bundesland.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bundesland.tsv) nach Bundesland und `region_type` gefiltert werden.  Die GISD-Scores dieser Datei sind zwischen Bundesländern nicht vergleichbar. 
> Für Vergleiche von GISD-Scores aus unterschiedlichen Bundesländern muss die Datei [GISD_Bund.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bund.tsv) verwendet werden.
...
* GISD-Dezil für den jeweiligen Bezugsrahmen
* GISD-Kategorien
* Beobachtungsjahr

#### Variablenausprägungen auf Bundesebene
<!-- DATA_SCHEMA_SPECIFICATION_START: {"id": "GISD_Bund", "lang": "de"} -->

Die Datei [GISD_Bund.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bund.tsv) enthält die in der folgenden Tabelle abgebildeten Variablen und deren Ausprägungen. Ein maschinenlesbares Datenschema ist im [Data Package Standard](https://datapackage.org/) in [tableschema_GISD_Bund.json](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Metadaten/schemas/tableschema_GISD_Bund.json) hinterlegt:

> [tableschema_GISD_Bund.json](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Metadaten/schemas/tableschema_GISD_Bund.json)

<!-- DATA_SCHEMA_TABLE_START -->
| Variable    | Typ     | Ausprägungen                                                                         | Beschreibung                                                                                                                                                                                                                                                               |
|:------------|:--------|:-------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| region_type | string  | Werte:<br>`Gemeinde`, `Gemeindeverband`, `Kreis`, `NUTS2`, `PLZ2`, `PLZ3`, `PLZ4`, … | Regionale Ebene der regionalen Einheit, für die Analyse muss der Datensatz auf die Analyseebene eingeschränkt werden [Datenbereitstellung](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Readme.md#Datenbereitstellung) |
| region_id   | string  | Beispiel:<br>`14523130`                                                              | ID der regionalen Einheit basierend auf dem amtlichen Regionalschlüssel für Gemeinden, Gemeindeverbände , Stadt- und Landkreise, NUTS-2, Raumordnungsregion sowie Postleitzahl 2-, 3-, 4-, 5-Steller                                                                       |
| region_name | string  | Beispiele:<br>`15566`, `Oberbergischer Kreis`, `VVG der Stadt Gerabronn`             | Name der Raumeinheit                                                                                                                                                                                                                                                       |
| year        | integer | Werte:<br>`1998` - `2023`                                                            | Beobachtungsjahr                                                                                                                                                                                                                                                           |
| gisd_score  | number  | Werte:<br>`0` - `1`                                                                  | Berechneter Score sozioökonomischer Deprivation für die jeweilige Raumheinheit auf der jeweiligen regionalen Ebene                                                                                                                                                         |
| gisd_5      | integer | Werte:<br>`1` - `5`                                                                  | Zugewiesenes GISD-Quintil der Raumeinheit gemäß der jährlichen Verteilung auf der jeweiligen räumlichen Ebene                                                                                                                                                              |
| gisd_10     | integer | Werte:<br>`1` - `10`                                                                 | Zugewiesenes GISD-Dezil der Raumeinheit gemäß der jährlichen Verteilung auf der jeweiligen räumlichen Ebene                                                                                                                                                                |
| gisd_k      | integer | Werte:<br>`1` - `3`                                                                  | 1 unterstes Quintil, 2 drei mittlere Quintil, 3 oberstes Quintil                                                                                                                                                                                                           |
...
<!-- DATA_SCHEMA_SPECIFICATION_START: {"id": "GISD_Bundesland", "lang": "de"} -->

Die Datei [GISD_Bundesland.tsv](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Bundesland.tsv) enthält die in der folgenden Tabelle abgebildeten Variablen und deren Ausprägungen. Ein maschinenlesbares Datenschema ist im [Data Package Standard](https://datapackage.org/) in [tableschema_GISD_Bundesland.json](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Metadaten/schemas/tableschema_GISD_Bundesland.json) hinterlegt:

> [tableschema_GISD_Bundesland.json](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Metadaten/schemas/tableschema_GISD_Bundesland.json)

<!-- DATA_SCHEMA_TABLE_START -->
| Variable      | Typ     | Ausprägungen                                                                                                                           | Beschreibung                                                                                                                                                                                                                                                                       |
|:--------------|:--------|:---------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| federal_state | string  | Werte:<br>`Baden-Wuerttemberg`, `Bayern`, `Brandenburg`, `Hessen`, `Mecklenburg-Vorpommern`, `Niedersachsen`, `Nordrhein-Westfalen`, … | Das Bundesland, das den Bezugsrahmen für den GISD Score bildet, für die Analyse muss der Datensatz auf ein Bundesland eingeschränkt werden                                                                                                                                         |
| region_type   | string  | Werte:<br>`Gemeindeverband`, `Kreis`                                                                                                   | Regionale Ebene, für die Analyse muss der Datensatz auf die jeweilige Analyseebene eingeschränkt werden, Details dazu im Abschnitt [Regionale Ebenen](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Readme.md#regionale-ebenen) |
| region_id     | string  | Beispiel:<br>`14523130`                                                                                                                | ID der regionalen Einheit basierend auf dem amtlichen Regionalschlüssel für Gemeinden, Gemeindeverbände, Stadt- und Landkreise, NUTS-2, Raumordnungsregion sowie Postleitzahl 2-, 3-, 4-, 5-Steller                                                                                |
| region_name   | string  | Beispiele:<br>`15566`, `Oberbergischer Kreis`, `VVG der Stadt Gerabronn`                                                               | Name der Raumeinheit                                                                                                                                                                                                                                                               |
| year          | integer | Werte:<br>`1998` - `2023`                                                                                                              | Beobachtungsjahr                                                                                                                                                                                                                                                                   |
| gisd_score    | number  | Werte:<br>`0` - `1`                                                                                                                    | Score sozioökonomischer Deprivation für die jeweilige Raumheinheit auf der jeweiligen regionalen Ebene min-max-normalisiert für das Bundesland                                                                                                                                     |
...
Die Daten sind im Datensatz als kommaseparierte `.tsv`-Datei enthalten. Der verwendete Zeichensatz der `.tsv`-Datei ist UTF-8. Trennzeichen der einzelnen Werte ist ein Komma `\t`.   

* Zeichensatz: `UTF-8`  
* Datumsformat: `ISO8601`  
* Trennzeichen: `\t`  

Die Daten werden auch als `.xslx`-Dateien im Ordner [GISD_Release_aktuell](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/GISD_Release_aktuell/) bereitgestellt.
...
Aktualisierung & Bugfixes in der Version 2026-05-18:
* Die Aktualisierung führt eine neue GISD-Version GISD_Release_2026_v0.1 ein. Die Version enthält Daten bis 2023. Für zwei Indikatoren wurden für das Jahr 2023 keine Rohdaten aus der INKAR-Datenbank verwendet, weil diese noch nicht bereitstanden. Die Rohdaten für die Indikatoren Haushaltseinkommen und Bruttoverdienst wurden stattdessen direkt aus der Primärquelle (Volkswirtschaftliche Gesamtrechnung - VGR) bezogen. Um die leichten Abweichungen, die sich aus dem Vergleich der VGR-Rohdaten mit den INKAR-Daten der Vorjahre ergaben zu berücksichten, wurden die Werte für 2023 aus der VGR mittels regressionsbasierter Imputation auf die Skala von INKAR kalibriert. 
* GISD_Release_2026_v0.1 ersetzt die GISD-Version GISD_Release_2025_v1.0 als aktuelles Release. GISD_Release_2025_v1.0 wird dem Archiv hinzugefügt.
...
* GISD_Release_2026_v0.1 enthält GISD-Scores für die Jahre bis 2023. Im Zuge der Generierung wurden auch die Werte aller weiteren Jahre revidiert. 
* Neben der Revision der GISD-Scores in GISD_Release_2026_v0.1 wird auch GISD_Release_2022_v1.0 fortgeführt und um die Jahre 2022 und 2023 ergänzt. Die Fortschreibung findet sich in der Version [GISD_Release_2022_v1.3_Fortschreibung](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/tree/main/Archiv). Sie wendet die Gewichtung der Indikatoren und den Gebietsstand (31.12.2019) aus der GISD-Version GISD_Release_2022_v1.1 auf die Rohdaten der Jahre 2020 bis 2023 an.
* Seit GISD_Release_2026_v0.1 stehen die Rohdaten für den Indikator "Einkommensteuer" auf Gemeindeebene statt auf Gemeindeverbandsebene für die gesamte Zeitreihe zu Verfügung, wodurch eine höhere Auflösung erreicht wird.
* Die Ost-West-Korrektur des Indikators "Beschäftigte ohne Abschluss" wurde so angepasst, dass sie nun über die Beobachtungsjahre variiert.
* Die in der letzten Aktualisierung eingeführten Glättungen von Ausreißern, die eine Harmonisierung der Zeitreihen in den Daten zum Ziel hatten, werden nicht mehr für die bereits aggregierten  Dimensionen vorgenommen, sondern erfolgen nun als Ausreißerkorrektur auf Ebene der Rohdaten. 
* In den letzten Aktualisierungen gab es leichte Unterschiede zwischen dem Gebietsstand der Postleitzahlbereiche und dem Gebietsstand der Gemeinden. Im aktuellem Release beziehen sich beide Gebietsstände auf den 31.12.2023.
* Mit dem GISD_Release_2026_v0.1 wurden neue Dateiformate und Datenstrukturen eingeführt. Das Datenformat `.csv` wird durch das Datenformat `.tsv` ersetzt. Auf das Stata-Datenformat wird verzichtet. Dafür werden die Daten nun auch im Excel-Format`.xlsx` bereitgestellt. Die neuen Datenstrukturen werden im Kapitel [Datenformate](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Readme.md#Datenbereitstellung) und [im Kapitel Variablen und Variablenausprägungen](https://github.com/robert-koch-institut/German_Index_of_Socioeconomic_Deprivation_GISD/blob/main/Readme.md#Variablen-und-Variablenauspr%C3%A4gungen) beschrieben. 
* Mit dem GISD_Release_2026_v0.1 enthalten die bundeslandspezifischen Daten GISD-Werte für die Gemeinde und Kreisebene. Die Gemeindeverbandsebene (GVB) entfällt. Die bundeslandspezifischen Daten enthalten nun außerdem GISD-Dezile, GISD-Quintile und GISD-Kategorien.
...
* GISD_Release_2025_v1.0 nimmt Glättungen von Ausreißern bei den Teildimensionen Beschäftigung und Einkommen vor, die bisher zu Brüchen in den Zeitreihen für die Teildimensionen und für den GISD geführt haben.
